...
class SelectableTextTapWorkaroundWrapper extends StatefulWidget {
  ...
  @override
  _SelectableTextTapWorkaroundWrapperState createState() =>
      _SelectableTextTapWorkaroundWrapperState();
}

class _SelectableTextTapWorkaroundWrapperState
    extends State<SelectableTextTapWorkaroundWrapper> {
  ...
  void _checkTap() {
    if (_currentTapUrlSpanIndex != null) {
      final span =
          widget.textSpan.children[_currentTapUrlSpanIndex] as TextSpan;
